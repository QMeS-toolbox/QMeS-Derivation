...
(* ::Input::Initialization:: *)
ReduceIdenticalFlowDiagrams[diags_]:=Module[{separatedGroups,reduceGroup,reducedGroups},
AssertAllSuperIndexDiagrams[diags,"ReduceIdenticalFlowDiagrams"];

separatedGroups={diags};SeparateSuperIndexDiagramGroups[diags];
...
identities=Map[CheckOneLoopDiagramIdentity[groupDiags[[i]],#]&,groupDiags[[i+1;;]]];
...
reducedGroups=Map[reduceGroup,separatedGroups];
...
(* ::Input:: *)
(*QMeSderivation`Tools`*)


(* ::Input:: *)
(*DerivativeListqbq= {qb[-p,{d2,c2,f2}],q[p,{d1,c1,f1}]};*)
(*Diagramsqbq = DeriveFunctionalEquation[SetupfRG,DerivativeListqbq,"OutputLevel"->"SuperindexDiagrams"];*)
...
(* ::Input:: *)
(**)
(*SuperindexToFullDiagrams[Diagramsqbq,DerivativeListqbq,SetupfRG]*)
